...
;(async () => {
  ...
  try {
    ...
    const GSTCompliance = "#gstComplianceNo"
    ...
    let fileToUploadAAdhar =
      "/Users/arpitapandey/OfficeProjects/pupet-test/src/fileholder/aadhar.png"
    ...
    const declineAccount =
      "/html/body/div[3]/div/div[1]/div/div/div[2]/div[7]/button[1]/span"
    const declineAccountElement = await page1.waitForSelector(
      `xpath/${declineAccount}`
    )
    await declineAccountElement.click()
    console.log("Clicked on declined account in Accounts panel")
    ...
    await page1.waitForSelector(
      "div.modal.fade.show .modal-dialog .modal-content .modal-body",
      {
        visible: true
      }
    )
    ...
    const rejectionClick =
      "/html/body/div[4]/div/div[1]/div/div/div[3]/button[1]"
